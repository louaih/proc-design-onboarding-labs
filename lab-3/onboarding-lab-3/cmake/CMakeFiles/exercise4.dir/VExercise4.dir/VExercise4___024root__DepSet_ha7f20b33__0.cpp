...
VL_INLINE_OPT void VExercise4___024root___ico_sequent__TOP__0(VExercise4___024root* vlSelf) {
    ...
    // Body
    vlSelf->out = ((IData)(vlSelf->cs) ? ((0U == (IData)(vlSelf->sel))
                                           ? (IData)(vlSelf->alpha)
                                           : ((1U == (IData)(vlSelf->sel))
                                               ? (IData)(vlSelf->beta)
                                               : ((2U 
...
#endif
            VL_FATAL_MT("/home/louai/proc-design-onboarding-labs/lab-3/onboarding-lab-3/rtl/Exercise4.sv", 13, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("/home/louai/proc-design-onboarding-labs/lab-3/onboarding-lab-3/rtl/Exercise4.sv", 13, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("/home/louai/proc-design-onboarding-labs/lab-3/onboarding-lab-3/rtl/Exercise4.sv", 13, "", "Active region did not converge.");
            }
