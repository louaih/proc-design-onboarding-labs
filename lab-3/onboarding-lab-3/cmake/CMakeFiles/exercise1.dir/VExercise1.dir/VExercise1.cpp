...
VL_ATTR_COLD void VExercise1::trace(VerilatedVcdC* tfp, int levels, int options) {
    vl_fatal(__FILE__, __LINE__, __FILE__,"'VExercise1::trace()' called on model that was Verilated without --trace option");
}
